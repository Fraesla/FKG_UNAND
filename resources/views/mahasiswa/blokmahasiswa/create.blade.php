                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Penambahan Data Blok Mahasiswa
                                </h3>
                            ...
                            <div class="card-body">
                                <form action="/mahasiswa/blokmahasiswa/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <select class="form-select" name="id_tahun_ajaran">
                                                ...
                                                <option value="{{$data->id}}">
                                                    Tahun Ajaran : {{$data->nama}} | Semester : Semester ke-{{$data->semester}}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
