        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-md-4 d-flex justify-content-end">
                ...
                <div class="profile-card">
                    ...
                    <img src="{{ $mahasiswa->foto ? asset('storage/'.$mahasiswa->foto) : asset('assets/images/default-fkg.jpg') }}" width="50" height="50" class="rounded-circle object-cover profile-img">

                    <div>
                        <div class="profile-name">Nama Mahasiswa : {{ $mahasiswa->nama }}</div>
                        <div class="profile-sub">No.BP : {{ $mahasiswa->nobp }}</div>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tabel Blok Mahasiswa</h3>
                </div>
                <form action="/mahasiswa/blokmahasiswa/feature" method="GET">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search data blok msahasiswa" 
                                       name="search" 
                                       placeholder="Cari Data blok mahasiswa..." 
                                       value="{{ request('search') }}">

                                <a href="/mahasiswa/blokmahasiswa/add" class="btn btn-success btn-mm ms-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                               <!--  <td>
                                ...
                                <td class="text-secondary">{{$data->tahun_ajar}}</td>
                                <td class="text-secondary">Semester ke-{{$data->semester}}</td>
                                <td class="text-secondary">{{$data->nobp}}</td>
                                <td class="text-secondary">{{$data->mahasiswa}}</td>
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/mahasiswa/blokmahasiswa/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $blok->firstItem() }}</strong>
                                to
                                <strong>{{ $blok->lastItem() }}</strong>
                                of
                                <strong>{{ $blok->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
                           {{ $blok->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/mahasiswa/blokmahasiswa/delete/" + id;
        }
    })
}
</script>
