         ...
         <div class="col">
            <!-- Page pre-title -->
               <div class="page-pretitle">Aplikasi FKG</div>
                  <h2 class="page-title">Seminar Hasil</h2>
              </div>
              <!-- Page title actions -->
      </div>
   </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="space-y">
                                        ...
                                        <div class="mb-3">
                                          <div class="form-label">Surat Permohonan Undangan Seminar Hasil</div>
                                        ...
                                        <div class="mb-3">
                                          <div class="form-label">Bukti Izin Seminar Hasil</div>
                                          <input type="file" class="form-control" />
                                        </div>
                                        <div class="mb-3">
                                          <div class="form-label">Lembar ceklis Jadwal Seminar Hasil</div>
                                          <input type="file" class="form-control" />
                                        </div>
                                        <div>
                                            <a href="/mahasiswa/seminar/hasil" class="btn btn-primary btn-4 w-100">
                                                Simpan
