                  ...
                  <div class="card-body">
                    <div class="row gy-3">
                      <div class="col-12 col-sm d-flex flex-column">
                        <h3 class="h2">Welcome back, Mahasiswa</h3>
                        <p class="text-muted">Sistem Informasi Perpustakaan adalah sebuah sistem berbasis komputer yang digunakan untuk mengelola seluruh kegiatan operasional perpustakaan secara otomatis dan terintegrasi, seperti pengelolaan data buku, data anggota, proses peminjaman dan pengembalian buku, serta pencatatan denda dan laporan.</p>
                      </div>
