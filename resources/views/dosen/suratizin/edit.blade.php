...
'activePage' => 'suratizin'.$suratizin->id_prodi,
])
@section('content')
<!-- BEGIN PAGE HEADER -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="/dosen/suratizin/{{$suratizin->id_prodi}}" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                ...
                                {{ csrf_field() }}
                                    <div class="space-y">
                                                ...
                                                <label class="form-label">Dosen Pembimbing 1</label>
                                                 <select class="form-select" name="dosen_pembimbing_1">
                                                    ...
                                                    @foreach($dosen as $data)
                                                        <option value="{{$data->id}}"
                                                            {{ $suratizin->dosen_pembimbing_1 == $data->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label">Dosen Pembimbing 2</label>
                                                 <select class="form-select" name="dosen_pembimbing_2">
                                                    ...
                                                    @foreach($dosen as $data)
                                                        <option value="{{$data->id}}"
                                                            {{ $suratizin->dosen_pembimbing_2 == $data->id ? 'selected' : '' }}>
                                                            NIDM : {{$data->nip}} | Nama Dosen : {{$data->nama}}  
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <input type="hidden" name="id_prodi" value="{{$suratizin->id_prodi}}">
                                        <div>
