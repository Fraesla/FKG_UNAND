                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="/dosen/ta/{{$ta->id_prodi}}" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                <form action="/dosen/ta/update/{{$ta->id}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="id_prodi" value="{{$ta->id_prodi}}">
                                        <div>
