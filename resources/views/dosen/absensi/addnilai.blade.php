         ...
         <div class="col">
            <!-- Page pre-title -->
               <div class="page-pretitle">Aplikasi FKG</div>
                  <h2 class="page-title">Penilaian Absen</h2>
              </div>
              <!-- Page title actions -->
      </div>
   </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="space-y">
                                        <div>
                                            <label class="form-label">Nama Mahasiswa & No.BP</label>
                                            <select class="form-select">
                                                <option>
                                                    Pilih Nama Mahasiswa | No.BP
                                                </option>
                                                <option>
                                                    Test 1 | 109848981
                                                </option>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nilai" class="form-control"/>
                                        </div>
                                        <div>
