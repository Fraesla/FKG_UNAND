    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Ubah Password Akun Dosen</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="password-box">
                    ...
                    <a href="/dosen/dashboard" class="btn btn-secondary btn-sm btn-back-inside">
                        ← Back
                    </a>

                    <h4 class="text-white mb-4">Form Ubah Password</h4>

                    <form action="/dosen/updatePass" method="POST">
                        @csrf
