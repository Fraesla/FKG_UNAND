                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Pengeditan Data Nilai
                                </h3>
                                <a href="/dosen/nilai/" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                <form action="/dosen/nilai/update/{{$nilai->id}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select" name="id_kelas">
                                                    ...
                                                    <option value="{{$data->id}}" {{ $nilai->id_makul == $data->id ? 'selected' : '' }}>
                                                        {{$data->nama}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select" name="id_dosen">
                                                    ...
                                                    <option value="{{$data->id}}" {{ $nilai->id_dosen == $data->id ? 'selected' : '' }}>
                                                        {{$data->nama}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <select class="form-select" name="id_mahasiswa">
                                                    ...
                                                    <option value="{{$data->id}}" {{ $nilai->id_mahasiswa == $data->id ? 'selected' : '' }}>
                                                        {{$data->nama}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nilai" class="form-control" name="nilai" value="{{$nilai->nilai}}"/>
                                            @error('nilai')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
