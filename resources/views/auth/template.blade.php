...
<html lang="en">
  <head>
    ...
    <link href="{{url('assets')}}/dist/css/tabler.css?1747674012" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="{{url('assets')}}/dist/css/tabler-flags.css?1747674012" rel="stylesheet" />
    <link href="{{url('assets')}}/dist/css/tabler-socials.css?1747674012" rel="stylesheet" />
    <link href="{{url('assets')}}/dist/css/tabler-payments.css?1747674012" rel="stylesheet" />
    <link href="{{url('assets')}}/dist/css/tabler-vendors.css?1747674012" rel="stylesheet" />
    <link href="{{url('assets')}}/dist/css/tabler-marketing.css?1747674012" rel="stylesheet" />
    <link href="{{url('assets')}}/dist/css/tabler-themes.css?1747674012" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="{{url('assets')}}/preview/css/demo.css?1747674012" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
  ...
  <body>
    ...
    <script src="{{url('assets')}}/dist/js/tabler-theme.min.js?1747674012"></script>
    ...
    <script src="{{url('assets')}}/dist/js/tabler.min.js?1747674013" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="{{url('assets')}}/preview/js/demo.min.js?1747674013" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
