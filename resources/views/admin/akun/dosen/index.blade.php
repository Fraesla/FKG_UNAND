            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="ms-auto d-flex flex-wrap btn-list">
                        <a href="/admin/dosen/add" class="btn btn-0 btn btn-primary"> ADD </a>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <a href="/admin/dosen/edit/{{$data->id}}" class="btn btn-warning w-10">Edit</a>
                                </td>
                                <td class="w-0">
                                    <a href="/admin/dosen/delete/{{$data->id}}" class="btn btn-danger w-10">Delete</a>
                                </td>
                                <!-- <td class="text-end">
                                    <span class="dropdown">
