                                ...
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan NIM" class="form-control" name="nidm" />
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control" placeholder="Masukkan Tanggal Lahir" id="datepicker-icon-prepend" name="tgl_lahir">
                                            </div>
                                        </div>
                                        <div class="mb-3">
