                ...
                <div class="row row-cards">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin/dosen/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            <label class="form-label">Nama Dosen</label>
                                            <input type="text" placeholder="Masukkan Nama Dosen" class="form-control" name="nama" />
                                            @error('nama')
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Pangkat / Golongan" class="form-control" name="pangol" />
                                            @error('pangol')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div>
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control" placeholder="Masukkan Naik Pangkat Terakhir" id="datepicker-icon-prepend" name="napater" >
                                            </div>
                                            @error('napater')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Naik Pangkat Berikutnya" class="form-control" name="napaber" />
                                            @error('napaber')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan JF" class="form-control" name="jf" />
                                            @error('jf')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="input-icon">
                                                <span class="input-icon-addon"><!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
                                                    ...
                                                    <path d="M11 15h1"></path>
                                                    <path d="M12 15v3"></path></svg></span>
                                                <input class="form-control" placeholder="Masukkan Naik Jabatan Terakhir" id="datepicker-icon-prepend_2" name="najater" >
                                            </div>
                                            @error('najater')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Pendidikan Terakhir" class="form-control" name="penter" />
                                            @error('penter')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Keterangan" class="form-control" name="keterangan" />
                                            @error('keterangan')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
