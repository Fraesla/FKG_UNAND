                                ...
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan NIM" class="form-control" name="nim" value="{{$mahasiswa->nim}}" />
                                        </div>
                                        <div>
                                            <label class="form-label">Nama Mahasiswa</label>
                                            <input type="text" placeholder="Masukkan Nama Mahasiswa" class="form-control" name="nama" value="{{$mahasiswa->nama}}" />
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control" placeholder="Masukkan Tanggal Lahir" id="datepicker-icon-prepend" name="tgl_lahir" value="{{$mahasiswa->tgl_lahir}}">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan No.HP" class="form-control" name="no_hp" value="{{$mahasiswa->no_hp}}"/>
                                        </div>
                                        <div>
                                            <label class="form-label">Gmail</label>
                                            <div class="input-group mb-2">
                                                <span class="input-group-text"> @ </span>
                                                <input type="text" class="form-control" placeholder="Masukkan Gmail" name="gmail" value="{{$mahasiswa->gmail}}" autocomplete="off" >
                                            </div>
                                        </div>
                                        <div class="mb-3">
