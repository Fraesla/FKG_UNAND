    ...
    <div class="container-xl">
        <div class="col-12">
            <div class="card">
                ...
                <form action="/admin/jurusan/feature" method="GET">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search data jurusan" 
                                       name="search" 
                                       placeholder="Cari Data Jurusan ..." 
                                       value="{{ request('search') }}">

                                <a href="/admin/jurusan/add" class="btn btn-success btn-mm ms-2">
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/jurusan/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/jurusan/delete/" + id;
        }
    })
}
</script>
