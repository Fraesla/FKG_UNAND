                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Pengeditan Data Ruangan
                                </h3>
                                <a href="/admin/ruangan/" class="btn btn-secondary btn-sm">
                                ...
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Ruangan" class="form-control" name="nama" value="{{$ruangan->nama}}" />
                                            @error('nama')
