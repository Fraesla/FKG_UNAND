            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <!-- Tombol Import -->
                            <form action="/admin/kelas/import" method="POST" enctype="multipart/form-data" class="d-inline-block me-2">
                                @csrf
                            ...
                            <!-- Tombol Export
                            <a href="/admin/kelas/export" class="btn btn-info btn-mm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" 
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/kelas/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/kelas/delete/" + id;
        }
    })
}
</script>
