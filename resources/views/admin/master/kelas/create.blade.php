                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="/admin/kelas/" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                <form action="/admin/kelas/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Blok" class="form-control" name="nama" />
                                            @error('nama')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
