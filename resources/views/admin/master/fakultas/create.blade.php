                ...
                <div class="row row-cards">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin/fakultas/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            <label class="form-label">Nama Fakultas</label>
                                            <input type="text" placeholder="Masukkan Nama Fakultas" class="form-control" name="nama" value="{{ old('nama') }}" />
                                            @error('nama')
