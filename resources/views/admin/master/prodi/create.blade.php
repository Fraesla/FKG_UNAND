                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Penambahan Data Prodi
                                </h3>
                                <a href="/admin/prodi/" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                <form action="/admin/prodi/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Prodi" class="form-control" name="nama" />
                                            @error('nama')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
