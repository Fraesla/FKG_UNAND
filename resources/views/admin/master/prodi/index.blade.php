                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search data Prodi" 
                                       name="search" 
                                       placeholder="Cari Data Prodi ..." 
                                       value="{{ request('search') }}">

                                <a href="/admin/prodi/add" class="btn btn-success btn-mm ms-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" 
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/prodi/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $prodi->firstItem() }}</strong>
                                to
                                <strong>{{ $prodi->lastItem() }}</strong>
                                of
                                <strong>{{ $prodi->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/prodi/delete/" + id;
        }
    })
}
</script>
