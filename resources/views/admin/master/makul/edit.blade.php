                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Pengeditan Data Mata Kuliah
                                </h3>
                                <a href="/admin/makul/" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                <form action="/admin/makul/update/{{$makul->id}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            <label class="form-label">Kode Mata Kuliah</label>
                                            <input type="text" placeholder="Masukkan Kode Mata Kuliah" class="form-control" name="kode" value="{{$makul->kode}}" />
                                            @error('kode')
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Mata Kuliah" class="form-control" name="nama" value="{{$makul->nama}}" />
                                            @error('nama')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
