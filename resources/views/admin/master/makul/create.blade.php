                ...
                <div class="row row-cards">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin/makul/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            <label class="form-label">Kode Mata Kuliah</label>
                                            <input type="text" placeholder="Masukkan Kode Mata Kuliah" class="form-control" name="kode" />
                                            @error('kode')
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Mata Kuliah" class="form-control" name="nama" />
                                            @error('nama')
                                                <div class="text-danger small mt-1">⚠️ {{ $message }}</div>
                                            @enderror
                                        </div>
