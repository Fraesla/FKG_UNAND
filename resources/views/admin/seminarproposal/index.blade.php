        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Tabel Daftar Seminar Proposal</h3>
                ...
                <form action="/admin/seminarproposal/{{$id_prodi}}/feature" method="GET">
                    <div class="card-body border-bottom py-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <a href="/admin/seminarproposal/{{$id_prodi}}/add" class="btn btn-success btn-mm ms-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" 
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                    ...
                    <table class="table table-selectable card-table table-vcenter text-nowrap datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="w-1">
                                    No.
                                    <!-- Download SVG icon from http://seminarproposalbler.io/icons/icon/chevron-up -->
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            @forelse($seminar_proposal as $data)
                            <tr>
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/seminarproposal/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                                ...
                                <!-- <td class="w-0">
                                    <a href="/admin/seminarproposal/delete/{{$data->id}}" class="btn btn-danger w-10">Delete</a>
                                </td> -->
                                <!-- <td class="text-end">
                                    <span class="dropdown">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $seminar_proposal->firstItem() }}</strong>
                                to
                                <strong>{{ $seminar_proposal->lastItem() }}</strong>
                                of
                                <strong>{{ $seminar_proposal->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
                            <!-- <ul class="pagination m-0 ms-auto">
                                <li class="page-item disabled">
                                    <a class="page-link" href="#" tabindex="-1" aria-disabled="true">
                                        Download SVG icon from http://seminarproposalbler.io/icons/icon/chevron-left
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#">
                                        Download SVG icon from http://seminarproposalbler.io/icons/icon/chevron-right
                            ...
                            {{ $seminar_proposal->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/seminarproposal/delete/" + id;
        }
    })
}
</script>
