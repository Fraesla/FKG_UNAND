                                ...
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Mahasiswa" class="form-control" name="nama" value="{{$surataktifkuliah->nama}}"/>
                                        </div>
                                        <div>
                                            <label class="form-label">Tanggal Lahir</label>
                                            <input type="text" placeholder="Masukkan Tanggal Lahir" class="form-control" name="tgl_lahir" value="{{$surataktifkuliah->tgl_lahir}}"/>
                                        </div>
                                        <div>
