                    ...
                    <table class="table table-selectable card-table table-vcenter text-nowrap datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="w-1">
                                    No.
                                    <!-- Download SVG icon from http://surataktifkuliahbler.io/icons/icon/chevron-up -->
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            @forelse($surataktifkuliah as $data)
                            <tr>
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/surataktifkuliah/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                                ...
                                <!-- <td class="w-0">
                                    <a href="/admin/surataktifkuliah/delete/{{$data->id}}" class="btn btn-danger w-10">Delete</a>
                                </td> -->
                                <!-- <td class="text-end">
                                    <span class="dropdown">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $surataktifkuliah->firstItem() }}</strong>
                                to
                                <strong>{{ $surataktifkuliah->lastItem() }}</strong>
                                of
                                <strong>{{ $surataktifkuliah->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
                            <!-- <ul class="pagination m-0 ms-auto">
                                <li class="page-item disabled">
                                    <a class="page-link" href="#" tabindex="-1" aria-disabled="true">
                                        Download SVG icon from http://surataktifkuliahbler.io/icons/icon/chevron-left
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#">
                                        Download SVG icon from http://surataktifkuliahbler.io/icons/icon/chevron-right
                            ...
                            {{ $surataktifkuliah->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/surataktifkuliah/delete/" + id;
        }
    })
}
</script>
