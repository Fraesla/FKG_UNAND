            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="ms-auto d-flex flex-wrap btn-list">
                        <a href="/admin/absdosen/add" class="btn btn-0 btn btn-primary"> ADD </a>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                               <!--  <td>
                                ...
                                <td>{{ $data->ruangan }}</td>
                                <td class="w-0">
                                    <a href="/admin/absdosen/edit/{{$data->id}}" class="btn btn-warning w-10">Edit</a>
                                </td>
                                <td class="w-0">
                                    <a href="/admin/absdosen/delete/{{$data->id}}" class="btn btn-danger w-10">Delete</a>
                                </td>
                                <!-- <td class="text-end">
                                    <span class="dropdown">
