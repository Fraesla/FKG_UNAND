        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tabel Absensi Dosen</h3>
                </div>
                <form action="/admin/absdosen/feature" method="GET">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search data Absensi Dosen" 
                                       name="search" 
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/absdosen/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $absdosen->firstItem() }}</strong>
                                to
                                <strong>{{ $absdosen->lastItem() }}</strong>
                                of
                                <strong>{{ $absdosen->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
                            {{ $absdosen->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/absdosen/delete/" + id;
        }
    })
}
</script>
