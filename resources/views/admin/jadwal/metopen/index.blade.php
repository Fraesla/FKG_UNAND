    ...
    <div class="container-xl">
        <div class="col-12">
            <div class="card">
                ...
                <form action="/admin/jadmetopen/{{$id_prodi}}/feature" method="GET">
                    <div class="card-body border-bottom py-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <a href="/admin/jadmetopen/{{$id_prodi}}/add" class="btn btn-success btn-mm ms-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" 
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                    ...
                                    <div class="d-flex gap-1">
                                        @switch($data->makul)
                                            ...
                                            @case('Pleno')
                                                ...
                                                <a href="/admin/jadmetopen/absen/{{$data->id}}" 
                                                ...
                                                <!-- Materi -->
                                                <a href="/admin/jadmetopen/materi/{{$data->id}}" class="btn btn-secondary btn-sm p-1 btn-materi">
