    ...
    <div class="container-xl">
        <div class="col-12">
            <div class="card">
                ...
                <form action="/admin/jaddosen/feature" method="GET">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search data jaddosen" 
                                       name="search" 
                                       placeholder="Cari Data jaddosen ..." 
                                       value="{{ request('search') }}">

                                <a href="/admin/jaddosen/add" class="btn btn-success btn-mm ms-2">
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/jaddosen/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $jaddosen->firstItem() }}</strong>
                                to
                                <strong>{{ $jaddosen->lastItem() }}</strong>
                                of
                                <strong>{{ $jaddosen->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
                            {{ $jaddosen->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/jaddosen/delete/" + id;
        }
    })
}
</script>
