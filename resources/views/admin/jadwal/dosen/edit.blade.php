                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Pengeditan Data Jadwal Dosen
                                </h3>
                            </div>
                            <div class="card-body">
                                <form action="/admin/jaddosen/update/{{$jaddosen->id}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                             ...
                                             <select class="form-select" name="id_jadwal_makul">
                                                ...
                                                @foreach($jadmakul as $data)
                                                    <option value="{{$data->id}}"
                                                        {{ $jaddosen->id_jadwal_makul == $data->id ? 'selected' : '' }}>
                                        ...
                                        <div>
                                            <label class="form-label">Dosen</label>
                                             <select class="form-select" name="id_dosen">
                                                ...
                                                <option value="{{$data->id}}"
                                                    {{ $jaddosen->id_dosen == $data->id ? 'selected' : '' }}>
                                                    {{$data->nama}}
                                                </option>
                                                @endforeach
                                            </select>
