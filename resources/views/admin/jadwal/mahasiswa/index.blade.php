        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tabel Jadwal Mahasiswa</h3>
                </div>
               <form action="/admin/jadmahasiswa/feature" method="GET">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search data Jadwal Mahasiswa" 
                                       name="search" 
                                       placeholder="Cari Data Jadwal Mahasiswa ..." 
                                       value="{{ request('search') }}">

                                <a href="/admin/jadmahasiswa/add" class="btn btn-success btn-mm ms-2">
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/jadmahasiswa/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                    ...
                    <div class="row g-2 justify-content-center justify-content-sm-between">
                        <div class="col-auto d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <strong>{{ $jadmahasiswa->firstItem() }}</strong>
                                to
                                <strong>{{ $jadmahasiswa->lastItem() }}</strong>
                                of
                                <strong>{{ $jadmahasiswa->total() }}</strong>
                                entries
                            </p>
                        </div>
                        <div class="col-auto">
                            {{ $jadmahasiswa->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/jadmahasiswa/delete/" + id;
        }
    })
}
</script>
