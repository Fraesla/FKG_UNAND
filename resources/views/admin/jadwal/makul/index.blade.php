    ...
    <div class="container-xl">
        <div class="col-12">
         ...
         <!--  <div class="d-flex gap-2">
                ...
                <form action="/admin/jadmakul/{{$id_prodi}}/feature" method="GET">
                    <div class="card-body border-bottom py-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <a href="/admin/jadmakul/{{$id_prodi}}/add" class="btn btn-success btn-mm ms-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" 
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                                    ...
                                    <div class="d-flex gap-1">
                                        @switch($data->makul)
                                            ...
                                            @case('Pleno')
                                                ...
                                                <!-- Edit -->
                                                <a href="/admin/jadmakul/$data->id_prodi/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
