                                ...
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Alamat" class="form-control" name="alamat" value="{{$suratizin->alamat}}"/>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Gmail" class="form-control" name="gmail" value="{{$suratizin->gmail}}"/>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" placeholder="Masukkan Isi Surat" class="form-control" name="isi_surat" value="{{$suratizin->isi_surat}}"/>
                                        </div>
                                        <div>
