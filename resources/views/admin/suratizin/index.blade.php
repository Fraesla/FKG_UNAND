    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-md-8">
                ...
                <h2 class="page-title">Data Surat Izin Penelitian</h2>
            </div>
    ...
    <div class="container-xl">
        <div class="col-12">
            <div class="card">
                    ...
                    <!-- <div class="d-flex gap-2">
                        Tombol Import
                            <a href="#" class="btn btn-primary btn-mm">
                                ...
                                Upload Data Permohonan Surat Izin Penelitian
                            </a>
                ...
                <form action="/admin/suratizin/{{$id_prodi}}/feature" method="GET">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto text-secondary d-flex align-items-center">
                                ...
                                <input type="text" class="form-control form-control-mm" 
                                       aria-label="Search Data Permohonan Surat Izin Penelitian" 
                                       name="search" 
                                       placeholder="Cari Data Permohonan Surat Izin Penelitian..." 
                                       value="{{ request('search') }}">

                                <a href="/admin/suratizin/{{$id_prodi}}/add" class="btn btn-success btn-mm ms-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" 
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" 
                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                               ...
                               <!--  <td>
                                ...
                                <td class="w-0">
                                    <div class="d-flex gap-1">
                                        <!-- Tombol Edit -->
                                        <a href="/admin/suratizin/edit/{{$data->id}}" class="btn btn-warning btn-sm p-1">
                                ...
                                <!-- <td class="w-0">
                                    <a href="/admin/suratizin/delete/{{$data->id}}" class="btn btn-danger w-10">Delete</a>
                                </td> -->
                                <!-- <td class="text-end">
                                    <span class="dropdown">
...
function deleteData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/suratizin/delete/" + id;
        }
    })
}
</script>
