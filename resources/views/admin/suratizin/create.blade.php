                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">
                                    Penambahan Data Permohonan Surat Izin Penelitian
                                </h3>
                                <a href="/admin/suratizin/{{$id_prodi}}" class="btn btn-secondary btn-sm">
                            ...
                            <div class="card-body">
                                <form action="/admin/suratizin/create" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <div class="space-y">
                                        <div>
                                            <label class="form-label">Jenis</label>
                                            <input type="text" placeholder="Masukkan Jenis" class="form-control" name="jenis" />
                                            @error('jenis')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" placeholder="Masukkan Judul Penelitian" class="form-control" name="judul_penelitian" />
